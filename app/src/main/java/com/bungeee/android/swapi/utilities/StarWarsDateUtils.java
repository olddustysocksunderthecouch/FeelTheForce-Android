...
/**
 * Class for handling date conversions that are potentially useful for SWAPI.
 */
public final class StarWarsDateUtils {
//
...
//     * the local time zone. For bungeee, if you live in California and the day is September 20th,
...
//     * <p>
//     * As another bungeee, if you are in Hong Kong and the day is September 20th, 2016 and it is
...
//     * For all days after that: "Mon, Jun 8" (Mon, 8 Jun in UK, for bungeee)
//     *
