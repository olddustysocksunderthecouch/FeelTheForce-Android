package com.bungeee.android.swapi.ui.starwarstextcrawl;
...
public class StarWarsTextView extends TextView {
    ...
    public boolean onPreDraw() {
        ...
        setPivotX(getMeasuredHeight() / 2);
        setPivotY(getMeasuredWidth() / 2);
    ...
    public Animator startAnimation() {
        if (animatorSet == null) {
            ...
            ValueAnimator scrollAnimator = ValueAnimator.ofInt(-getMeasuredWidth(),
            ...
            if (duration == -1) {
                duration = ((getMeasuredWidth() / getLineHeight()) + getLineCount()) * 1000;
            }
